...
import 'package:museum_app/page/detail_page.dart';
import 'package:museum_app/widget/expanded_content_widget.dart';
import 'package:museum_app/widget/image_widget.dart';
  ...
  void openDetailPage() {
    ...
    Navigator.of(context).push(
      PageRouteBuilder(
        ...
        pageBuilder: (context, x, secondaryAnimation) {
          ...
          return FadeTransition(
            ...
            child: DetailPage(location: widget.location, y: x),
          );
        },
      ),
    );
